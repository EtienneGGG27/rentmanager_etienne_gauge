                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <h3 class="profile-username text-center"> ${client.prenom} ${cient.nom} (${client.email})</h3>
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${reservations}" var="reservations" varStatus="loop">
                                            <tr>
                                                <td>${reservations.idReservation}</td>
                                                <td>${reservations.idVehicule}</td>
                            ...
                            <div class="tab-pane" id="cars">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td>${vehicles.idVehicle}.</td>
                                            <td>${vehicles.modele}</td>
                                            <td>${vehicles.constructeur}</td>
                                            <td>${vehicles.nb_places}</td>
                                        </tr>
                                        </c:forEach>
                                    </table>
                                </div>
